...
ConvertDataUnits = {
    ...
    "Length": {"meter": (1.0, ["m", "meters", "metre"]),
               ...
               "barrel per acre": (0.00000392866176, ["bbl/acre", ]),  # calculated from HCP
               "barrel per square mile": (0.0000006138533995, ["bbl/sq.mile", ]),  # calculated from HCP
               "gallon per acre": (0.0000093539563202687404, ["gal/acre", ]),  # calculated from HCP
    ...
    "Volume": {"cubic meter": (1.0, ["m^3", "cu m", "cubic meters"]),
               ...
               "fluid ounce": (2.9573530e-5, ["fl oz", "ounces(fluid)", "fluid oz", "fl. oz.", "oz. fl."]),
