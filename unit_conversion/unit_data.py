...
"Oil Concentration": {"micron": (1.0, ["microns"]),
                      ...
                      "barrel per square mile": (0.06138533995, ["bbl/sq.mile", "bbl/mile\N{SUPERSCRIPT TWO}"]),  # calculated from HCP
...
"Area": {"square meter": (1.0, ["m^2", "m\N{SUPERSCRIPT TWO}", "sq m"]),
         ...
         "square nautical mile": (3429904, ["sq nm", "nm^2", "nm\N{SUPERSCRIPT TWO}"]),  # calculated from HCP
         "square yard": (0.83612736, ["sq yards", "squareyards"]),
         "square foot": (0.09290304, ["ft^2", "ft\N{SUPERSCRIPT TWO}", "sq foot", "square feet"]),
         "square inch": (0.00064516, ["in^2", "in\N{SUPERSCRIPT TWO}", "sq inch", "square inches"]),
         "hectare": (10000.0, ["hectares", "ha"]),
         },

# All volumes in terms of cubic meter
"Volume": {"cubic meter": (1.0, ["m^3", "m\N{SUPERSCRIPT THREE}", "cu m", "cubic meters"]),
            "cubic kilometer": (1e9, ["km^3", "km\N{SUPERSCRIPT THREE}", "cu km", "cubic kilometers"]),
            "cubic centimeter": (1e-6, ["cm^3", "cm\N{SUPERSCRIPT THREE}", "cu cm", "cc"]),
            ...
            "cubic foot": (0.028316847, ["ft^3", "ft\N{SUPERSCRIPT THREE}", "cu feet", "cubicfeet"]),
            "cubic inch": (16.387064e-6, ["in^3", "in\N{SUPERSCRIPT THREE}", "cu inch", "cubicinches"]),
            "cubic yard": (.76455486, ["yd^3", "yd\N{SUPERSCRIPT THREE}", "cu yard", "cubicyards"]),
...
"Mass": {"kilogram": (1.0, ["kg", "kilograms"]),
          ...
          "metric ton (tonne)": (1000.0, ["mt", "tonnes", "metric ton", "metric tons"]),
          "slug": (14.5939, ["slugs"]),
...
"Discharge": {"cubic meter per second": (1.0, ["m^3/s", "m\N{SUPERSCRIPT THREE}/s", "cu m/s", "cms"]),
              "cubic meter per min": (1.0 / 60., ["m^3/min", "m\N{SUPERSCRIPT THREE}/min"]),
              "cubic meter per hour": (1.0 / 3600.0, ["m^3/hr", "m\N{SUPERSCRIPT THREE}/hr"]),
              "liter per second": (0.001, ["l/s", "lps"]),
              "liter per minute": (0.001 / 60, ["l/min",]),
              "cubic foot per second": (.02831685, ["cfs", "cu feet/s", "feet^3/s", "ft\N{SUPERSCRIPT THREE}/s"]),
              "cubic foot per minute": (0.00047194744, ["ft^3/min", "ft\N{SUPERSCRIPT THREE}/min"]),  # calculated from cm^3/s
...
"Density": {"gram per cubic centimeter": (1.0, ["g/cm^3", "g/cm\N{SUPERSCRIPT THREE}", "grams per cubic centimeter"]),
            "specific gravity (15\xb0C)": (0.99913, ["S", "specificgravity", "Spec grav", "SG", "specificgravity(15C)"]),
            "kilogram per cubic meter": (.001, ["kg/m^3", "kg/m\N{SUPERSCRIPT THREE}"]),
            "pound per cubic foot": (0.016018463, ["lbs/ft^3", "lb/ft\N{SUPERSCRIPT THREE}"]),
...
"Kinematic Viscosity": {"Stoke": (1.0, ["St", "stokes"]),
                        ...
                        "square millimeter per second": (.01, ["mm^2/s", "mm\N{SUPERSCRIPT TWO}/s", ]),
                        "square centimeter per second": (1.0, ["cm^2/s", "cm\N{SUPERSCRIPT TWO}/s", ]),
                        "square meter per second": (10000, ["m^2/s", "m\N{SUPERSCRIPT TWO}/s"],),
                        "square inch per second": (6.4516, ["in^2/s", "in\N{SUPERSCRIPT TWO}/s", "squareinchespersecond"]),
...
"Concentration In Water": {"kilogram per cubic meter": (1.0, ["kg/m^3", "kg/m\N{SUPERSCRIPT THREE}"]),
                           ...
                           "pound per cubic foot": (16.018450433864, ["lb/ft^3", "lb/ft\N{SUPERSCRIPT THREE}"]),
